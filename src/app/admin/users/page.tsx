                    ...
                    {guests.map((guest, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td style={{ padding: "14px 12px" }}>
                            {guest.user_id !== null && userMap[guest.user_id]
                              ? <span style={{ fontWeight: 600, color: "#374151" }}>{userMap[guest.user_id]}</span>
                          ...
                          <td style={{ padding: "14px 12px" }}>
                            <div style={{ display: "flex", gap: 6 }}>
                              <button
                                onClick={() => { setEditGuest(guest); setIsGuestModalOpen(true); }}
